...
/*
* Handling POST requests to the '/create' route.

* Use a validation middleware. If it fails, send an appropriate response to the client and does not call the next middleware. 
...
/*
* Handling POST requests to the '/authenticate' route.
...
/*
* Handling POST requests to the '/resetpassword' route.
